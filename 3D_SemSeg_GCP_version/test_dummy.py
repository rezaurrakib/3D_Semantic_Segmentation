...
def main(args):
    ...
    experiment_dir = '/home/reza/Desktop/thesis_tum/gcp_training_result/3d_semantic_segmentation/pointnet_e25_p4096/s3dis/' + args.log_dir
    ...
    '''MODEL LOADING'''
    #model_name_pkg = '/home/reza/Desktop/thesis_tum/3D-Segmentation/pointnet/'
    #model_name = importlib.import_module('.semantic_seg_model', package=model_name_pkg)
    #model_name = os.listdir(experiment_dir+'/logs')[0].split('.')[0]
    model_name = importlib.import_module('.pointnet_sem_seg', package='models')
    #MODEL = importlib.import_module(model_name)
    classifier = model_name.get_model(NUM_CLASSES).cuda()
