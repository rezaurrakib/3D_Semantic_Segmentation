...
from dataset_processing.s3dis_preprocess import S3DISDataset
from dataset_processing.shapenet_preprocess import ShapeNetDataProcess
...
class SemanticSegTraining():
    ...
    def load_model_for_training(self):
        model = importlib.import_module('.semantic_seg_model', package=self.parser_obj.model)
